...
export function slugForBarligName(name) {
  ...
  return slugByName.get(key) ?? null;
}
...
export const BARLIG_CLASSIFICATIONS = [
  {
    ...
    locationGroups: [
      {
        label: "Commercial lots located along National Road.",
        barangays: ["gawana", "fiangtin", "lingoy-upper"],
      },
    ],
  },
  {
    ...
    locationGroups: [
      {
        label: "Residential lots located along National Road (Barlig - Natonin Road).",
        barangays: ["gawana", "fiangtin", "lingoy-upper"],
      },
    ],
  },
  {
    ...
    locationGroups: [
      {
        label:
          "Residential lots along Bauman's Road (Gawana), Fiangtins Barangay Road, and Lingoy Barangay Road.",
        barangays: ["gawana", "fiangtin", "lingoy-upper"],
      },
    ],
  },
