...
// shared shell drives Besao without changes.
...
// PSA spells it "Padangan"; the LGU schedule spells it "Padangaan".
// Without this the barangay has no boundary and cannot be printed.
slugByName.set("padangan", "padangaan");
