...
//
// Two barangays (Balangao and Banawel) are not mentioned in the 2027
...
export const NATONIN_BARANGAYS = [
  ...
  { slug: "banawal", name: "Banawel", digitized: false },
...
// PSA spells it "Banawal"; the LGU schedule / local spelling uses "Banawel".
slugByName.set("banawal", "banawal");
...
export const NATONIN_CLASSIFICATIONS = [
  ...
  },
  {
    ...
    locationGroups: [
      {
        label:
          "Residential lots along the all-weather roads within Barangays Balangao and Banawel, and within the inner part of Butac, Santa Isabel, Alunogan, and Pudo.",
        barangays: [
          "balangao",
          "banawal",
          "butac",
  ...
  },
  {
    ...
    locationGroups: [
      {
        label:
          "Residential lots within the inner part of Barangay Maducayan, and within the inner parts of Balangao and Banawel.",
