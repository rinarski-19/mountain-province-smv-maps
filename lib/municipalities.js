...
const BAUKO_CONFIG = {
  ...
  dataFiles: {
    ...
    parcels: "/data/bauko_parcels.geojson",
    parcelsRevision: "/data/bauko_parcels.watch.json",
...
const BAUKO_PRINT_CONFIG = {
  ...
  tiles: {
    ...BAUKO_CONFIG.tiles,
    // Keep the print profile aligned with the vector print renderer.
...
const BARLIG_CONFIG = {
  ...
  dataFiles: {
    ...
    parcels: "/data/barlig_parcels.geojson",
...
const BONTOC_CONFIG = {
  ...
  dataFiles: {
    ...
    // Cadastral parcel polygons imported from BONTOC MAP PROJECTION.dxf
    // (closed declared-property polylines, transformed from PRS92 Zone III
    // to WGS84).
    parcels: "/data/bontoc_parcels.geojson",
    ...
    // the selected basemap tiles (e.g. Kalangeg Bldg). Edit by hand:
...
const SADANGA_CONFIG = {
  ...
  tiles: {
    ...
    // Sadanga uses OSM as the universal default.
  },
  ui: {
