...
const colorByClass = {
  ...
  "C-1": "#c63b24",
  "C-2": "#ec6bd6",
  // Residential R-1..R-3 share colors with same-value commercial
  // tiers. R-8..R-15 extend into deeper blues and slates — see
  // lib/classifications.js for the canonical copy.
  "R-1": "#c63b24",
  "R-2": "#ec6bd6",
  "R-3": "#fda4af",
  "R-4": "#8c458b",
    ...
    locationGroups: [
      {
        ...
        stretches: {
          poblacion: [
            "National Road: Circle → Kalangeg building (both sides)",
            "National Road: Circle → start of National Bridge fronting MPGCHS",
            "National Road: Circle → Municipal Capitol",
            "National Road: EDNP building → Barracks",
            "National Road: Gomez residence → Capitol junction",
            "Municipal Road: Wanchakan building → Pines Kitchenette → Circle (both sides)",
            "Municipal Road: JBA building → Pooten building",
          ],
        },
      },
    ],
    ...
    locationGroups: [
      {
        ...
        stretches: {
          "bontoc-ili": [
            "National Road: Joel Tad-awan building → Palinga-aw (toward Gonogon, both sides)",
            "Lanao Road",
          ],
          calutit: [
            "National Road: Centrum building (in front of DPWH) → Pingew Restaurant (both sides)",
          ],
          gonogon: [
            "National Road: Palinga-aw end (continues from Bontoc Ili stretch)",
          ],
          poblacion: [
            "National Road: Barracks → Cadre Road",
            "Municipal Road: Akfab Street",
            "Municipal Road: Fakeg Street",
            "Municipal Road: Kayyab Street",
            "Municipal Road: Sengang Street",
            "Municipal Road: Layad Street",
            "Municipal Road: Ayyoweng Street",
            "Municipal Road: Tugwi Street",
            "Municipal Road: Bishop Claver Road",
          ],
          samoki: [
            "National Road: end of National Bridge → Sukit (Anayas's Restaurant), both sides",
          ],
        },
      },
    ],
    ...
    locationGroups: [
      {
        ...
        stretches: {
          poblacion: [
            "National Road: Circle → EDNP building → Barracks",
            "Municipal Road: Wanchakan building → Pines Kitchenette → Circle (both sides)",
            "Municipal Road: JBA building → Pooten building",
          ],
          samoki: [
            "National Road: Circle → Malichom (Romel Lengwa Residence)",
          ],
          calutit: [
            "National Road: Circle → Pakkil (Morareng Residence)",
            "Bontoc–Baguio Road: Circle → Tikitik",
            "Caluttit–Plaza Road",
          ],
          "bontoc-ili": ["Eyeb–Lanao Road"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        stretches: {
          poblacion: [
            "National Road: end of Balikian Bridge → Amlosong",
            "Municipal Road: Akfab Street",
            "Municipal Road: Fakeg Street",
            "Municipal Road: Kayyab Street",
            "Municipal Road: Sengang Street",
            ...
            "Municipal Road: Ayyoweng Street",
            "Municipal Road: Tugwi Street",
            "Inner lots of Poblacion",
          ],
          calutit: [
            "National Road: Fagyan Residence → Pingew Restaurant",
          ],
          samoki: [
            "National Road of Samoki: from Malichom outward",
          ],
        },
      },
    ],
    ...
    locationGroups: [
      {
        ...
        stretches: {
          maligcong: [
            "Provincial Road (Bontoc–Maligcong): Bilibid Junction → Lengsad",
          ],
          mainit: [
            "Bontoc–Mainit Road: Post Office Junction → Pagturao",
          ],
        },
      },
    ],
    ...
    locationGroups: [
      {
        ...
        barangays: ["poblacion"],
        stretches: {
          poblacion: ["Inner lots of Poblacion"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        stretches: {
          "bontoc-ili": ["Inner lots of Bontoc Ili"],
          calutit: ["Inner lots of Caluttit"],
          samoki: ["Inner lots of Samoki"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        stretches: {
          "alab-oriente": ["National Road frontage"],
          "alab-proper": ["National Road frontage"],
          bayyo: ["National Road frontage"],
          gonogon: ["National Road frontage"],
          talubin: ["National Road frontage"],
          tocucan: ["National Road frontage"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        barangays: NATIONAL_ROAD_OUTER,
        stretches: {
          "alab-oriente": ["Inner lots along national road"],
          "alab-proper": ["Inner lots along national road"],
          bayyo: ["Inner lots along national road"],
          gonogon: ["Inner lots along national road"],
          talubin: ["Inner lots along national road"],
          tocucan: ["Inner lots along national road"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        stretches: {
          balili: ["Provincial Road frontage"],
          caneo: ["Provincial Road frontage"],
          guinaang: ["Provincial Road frontage"],
          mainit: ["Provincial Road frontage"],
          maligcong: ["Provincial Road frontage"],
          talubin: ["Provincial Road frontage"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        barangays: PROVINCIAL_ROAD_TIER,
        stretches: {
          balili: ["Inner lots along provincial road"],
          caneo: ["Inner lots along provincial road"],
          guinaang: ["Inner lots along provincial road"],
          mainit: ["Inner lots along provincial road"],
          maligcong: ["Inner lots along provincial road"],
          talubin: ["Inner lots along provincial road"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        stretches: {
          balili: ["Barangay Road frontage"],
          guinaang: ["Barangay Road frontage"],
          mainit: ["Barangay Road frontage"],
          maligcong: ["Barangay Road frontage"],
          talubin: ["Barangay Road frontage"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        barangays: BARANGAY_ROAD_TIER,
        stretches: {
          balili: ["Inner lots along barangay road"],
          guinaang: ["Inner lots along barangay road"],
          mainit: ["Inner lots along barangay road"],
          maligcong: ["Inner lots along barangay road"],
          talubin: ["Inner lots along barangay road"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        stretches: {
          gonogon: ["Gonogon outskirts"],
          talubin: ["Talubin (lower portions)"],
          tocucan: ["Tocucan interior"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        stretches: {
          caneo: ["Interior sitios of Can-eo"],
          gonogon: ["Hillside portions of Gonogon"],
          talubin: ["Upper Talubin"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        stretches: {
          dalican: ["Remote sitios of Dalican"],
          mainit: ["Remote sitios of Mainit"],
        },
      },
    ],
  },
    ...
    locationGroups: [
      {
        ...
        stretches: {
          caneo: ["Far-flung sitios (incl. Chapyosen)"],
          guinaang: ["Mountainous, far-flung sitios"],
          maligcong: ["Mountainous, far-flung sitios"],
        },
      },
    ],
  },
